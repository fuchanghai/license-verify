package com.changhaifu.license.bean;
...
public class LicenseVerify {
    ...
    public synchronized LicenseContent install(LicenseVerifyParam param){
        ...
        try{
           ...
           /* File licenese =new File(param.getLicensePath());
            if (!licenese.getParentFile().exists()){
                licenese.getParentFile().mkdirs();
            }
            if(!licenese.exists()){
                licenese.createNewFile();
            }*/
            // 安装
